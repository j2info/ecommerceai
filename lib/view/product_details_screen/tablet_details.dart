...
class TabletDetailsScreen extends StatefulWidget {
  const TabletDetailsScreen({super.key});

  @override
  State<TabletDetailsScreen> createState() => _TabletDetailsScreenState();
}

class _TabletDetailsScreenState extends State<TabletDetailsScreen> {
  List<Color> MyColors = [
    Color.fromARGB(255, 252, 50, 198),
    Colors.yellow,
    Colors.red,
